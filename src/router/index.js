...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'goods', name: 'Goods', meta: { name: 'Product Information' }, component: () => import('../views/manager/Goods') },
      { path: 'circles', name: 'Circles', meta: { name: 'Circle Information' }, component: () => import('../views/manager/Circles') },
      { path: 'posts', name: 'Posts', meta: { name: 'Community Post' }, component: () => import('../views/manager/Posts') },
      { path: 'help', name: 'Help', meta: { name: 'Wanted Information' }, component: () => import('../views/manager/Help') },
      { path: 'address', name: 'Address', meta: { name: 'Shipping Address' }, component: () => import('../views/manager/Address') },
      ...
      { path: 'orders', name: 'Orders', meta: { name: 'Order Information' }, component: () => import('../views/manager/Orders') },
    ]
  },
  {
    path: '/front',
