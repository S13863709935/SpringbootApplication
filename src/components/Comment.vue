        ...
        <div style="display: flex; margin-bottom: 20px">
          ...
          <div style="padding-left: 15px; flex: 1">
            ...
            <div v-if="item.showReply">
              <el-input type="textarea" placeholder="daily necessities" v-model="item.replyContent"></el-input>
...
export default {
  ...
  methods: {
    ...
    delComment(commentId) {   // 单个Delete
      this.$confirm('您确定Delete吗？', '确认Delete', {type: "warning"}).then(response => {
