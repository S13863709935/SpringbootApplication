<template>
  <div>
    <div class="search">
      <el-input v-model="orderNo" placeholder="Enter Order No." style="width: 200px; margin-right: 5px" clearable></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="orderNo" label="Order No." width="120"></el-table-column>
