  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="userId" label="Submitter ID"></el-table-column>
        <el-table-column prop="userName" label="Submitter Name"></el-table-column>
        <el-table-column label="Actions" align="center" width="180">
          <template v-slot="scope">
            <el-button size="mini" type="primary" plain @click="handleEdit(scope.row)">Reply</el-button>
    ...
    <el-dialog title="Feedback Information" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        <el-form-item label="Reply" prop="reply">
          <el-input type="textarea" v-model="form.reply" placeholder="Reply"></el-input>
        </el-form-item>
      </el-form>
...
<script>
export default {
  name: "Feedback", // Corrected from 'title' to standard Vue property 'name'
  data() {
    return {
      tableData: [],  // All data
