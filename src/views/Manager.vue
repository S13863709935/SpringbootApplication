  ...
  <div class="manager-container">
    <div class="manager-header">
      <div class="manager-header-left">
        ...
        <div class="title">Local Community Flea Market System Admin Panel</div>
      </div>
      ...
      <div class="manager-main-left">
        <el-menu :default-openeds="['info', 'user']" router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index="info">
            ...
            <el-menu-item index="/goods">Product Information</el-menu-item>
            <el-menu-item index="/orders">Order Information</el-menu-item>
            <el-menu-item index="/circles">Circle Information</el-menu-item>
            <el-menu-item index="/posts">Community Post</el-menu-item>
            <el-menu-item index="/help">Wanted Information</el-menu-item>
            <el-menu-item index="/address">Shipping Address</el-menu-item>
...
export default {
  ...
  methods: {
    updateUser() {
      this.user = JSON.parse(localStorage.getItem('xm-user') || '{}')   // Re-fetch the user's latest information
    },
    goToPerson() {
